...
UserProperties.prototype.GenAll = function() {
    return Generator.call(this, function(Properties, Field) {
        return true;
    });
};

UserProperties.prototype.GenComplement = function(Set) {
    return Generator.call(this, function(Properties, Field) {
...
UserProperties.GenIntersection = function(Set1, Set2) {
    var ToReturn = [];
...
UserProperties.prototype.GenAccess = function(Source) {
    return Generator.call(this, function(Properties, Field) {
        return Properties[Field].Access===Source;
    });
};
...
UserProperties.prototype.GenConfirm = function(Source) {
    return Generator.call(this, function(Properties, Field) {
        return(Properties[Field].Private&&Properties[Field].Required&&Properties[Field].Secret&&(Properties[Field].Access===Source));
    });
};

UserProperties.prototype.GenEditable = function(Source) {
    return Generator.call(this, function(Properties, Field) {
        if(!Source)
        {
        ...
        {
            return Properties[Field].Mutable && (Properties[Field].Access===Source);
        }
    });
};
